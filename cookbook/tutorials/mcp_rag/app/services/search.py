...
from lib.gemini_client import embed_content
from models.embedding import EmbeddingTaskTypeEnum
...
async def search_documents(query: str, match_threshold: float = None, match_count: int = None) -> List[Dict[str, Any]]:
    """
